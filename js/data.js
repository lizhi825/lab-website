...
const SiteData = {
    ...
    qa: JSON.parse(localStorage.getItem('site_qa') || JSON.stringify([
        ...
        { id: 2, question: '海智所招收本科生参与科研吗？有什么要求？', answer: '研究所长期面向全院本科生开放，欢迎对化学材料、机械、电气控制感兴趣的同学加入。要求热爱学习、热爱科研，无需基础，研究所会提供系统培训。有意向的同学可到一号实验楼401咨询。', time: '2026-06-25', user: '常见问题' },
        { id: 3, question: '加入研究所后主要做什么？', answer: '根据你的兴趣分配到不同研究组，参与导师指导的科研项目。可以学习学术论文撰写、掌握科研软件、培养逻辑思维，还能获得德育分和竞赛证书。优秀学生有机会发表SCI/EI论文。', time: '2026-06-20', user: '常见问题' },
        { id: 4, question: '研究所的联系方式是什么？', answer: '地址：荣成学院一号实验楼401。联系人：李智浩，电话：17667031628。也可以直接到实验室咨询，每周五下午为开放日。', time: '2026-06-15', user: '常见问题' },
    ])),
